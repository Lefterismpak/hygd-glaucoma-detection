...
>
> 📋 **[VALIDATION.md](VALIDATION.md) — honest external validation: the model fails zero-shot on other datasets (0.988 → ~0.5 on PAPILA), but a domain-generalization pipeline (disc-crop + multi-source + SWA + TTA) recovers held-out PAPILA to 0.83.** The full fail→fix story.
