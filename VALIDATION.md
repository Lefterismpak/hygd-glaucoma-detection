...
> **Current broader audit — 2026-09-06:** [v6 and the remainder audit](HYGD_REMAINDER_AUDIT_2026_09.md) distinguish four reproduced defects from prior results that still match their artifacts. The full corrected-loss run preserved v5 OOF bytes and performance. Mask-target and temperature-fit failures have their own bounded impact; they do not automatically invalidate unrelated disease AUROCs. [Current v6 receipt](results/v6_complete_run_20260906.json).
