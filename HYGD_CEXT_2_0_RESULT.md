...
> **Hash scope correction (2026-09-02):** the protocol hash below identifies
> the private byte-identical pre-download lock, which was locally reverified at
> that digest. It does not identify the later annotated public file
> `HYGD_CEXT_2_0_PROTOCOL.md`. The private lock/receipt is not distributed in
> this repository, so external reproduction of that mapping remains
> `needs-proof`; the numerical result and no-promotion verdict are unchanged.
...
| Private locked-protocol SHA-256 | `edea2a4c991c8b2e3c44ae23a3e26b601b82fa33ad889f7b8cd96b0865b4a721` |
...
- No training/evaluation image-hash or declared evaluation-group overlap was present; RIM-ONE biological-subject independence remains `needs-proof`.
...
The paths below identify private, unpublished workspace evidence. Their mapping
to this public aggregate narrative remains externally `needs-proof`; listing
hash-bound local roles does not make the underlying rows, predictions, or audit
